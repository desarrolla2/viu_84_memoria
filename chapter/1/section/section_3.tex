...
Como hemos visto en la sección~\ref{sec:plantenamiento_problema}
Planteamiento del problema, la relevancia de este TFG se fundamenta en la necesidad de implementar soluciones que
permitan automatizar el proceso de extracción de la información contenida en documentos de cualquier tipo y cualquier
formato.
