...
\textit{ChatGPT 4}~\cite{url_openai_gpt4} para determinar si eran más adecuados que los modelos
que se utilizaron en dicho trabajo.

Después de realizar una serie de pruebas durante este \textit{sprint}, se determinó que si bien \textit{Llama 3} es un
...
\textit{Residential Lease Agreement Processor} y \textit{Vehicle Sale And Purchase Agreement Processor} que introdujimos en la
