...
Hemos utilizado \textit{GitHub Actions} para que esta \textit{suite} se ejecutará automáticamente después de cada
...
\begin{itemize}
    ...
    ~\cite{url_monolog}.
    \item \textbf{Elasticsearch} es un motor de búsqueda y análisis de texto completo basado en Lucene.
...
En la sección~\ref{sec:implemetacion_y_programacion} Implementación y programación, ampliamos los detalles.
...
\begin{itemize}
    ...
    análisis de datos ~\cite{url_pdftotextl}.
\end{itemize}
