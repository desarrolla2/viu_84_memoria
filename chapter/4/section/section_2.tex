...
\textit{Residential Lease Processor} y \textit{Vehicle Sale And Purchase Processor}.

Las llamadas HTTP se realizaron mediante la librería \textit{Symfony HttpClient} y finalmente \textit{Symfony Cache}
